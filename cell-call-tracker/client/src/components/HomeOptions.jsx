...
export default function HomeOptions({ effectiveUser, setView, staffCount }){
  return (
    <div style={{display:'flex',gap:16}} className="home-options">
      {effectiveUser?.admin && (
      ...
      {/* Quick Stats card intentionally removed per request */}
    </div>
  )
}
import React from 'react'
...
export default function HomeOptions({ effectiveUser, staffCount, setView }){
  return (
